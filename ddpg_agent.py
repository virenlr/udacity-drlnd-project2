...
NUM_LEARN_UPDATES = 10              # the number of epochs of learning that happen at update time
NUM_TIME_STEPS_TO_UPDATE = 20       # after how many time steps to update the network
